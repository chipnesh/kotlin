...
fun ConeKotlinType.approximateIntegerLiteralType(expectedType: ConeKotlinType? = null): ConeKotlinType {
    return when (this) {
        ...
        is ConeFlexibleType -> approximateIntegerLiteralBoundsBounds(expectedType)
        else -> this
    }
}

private fun ConeFlexibleType.approximateIntegerLiteralBoundsBounds(expectedType: ConeKotlinType? = null): ConeFlexibleType {
