...
private fun ConeKotlinType.withCombinedCustomAttributesFrom(other: ConeAttributes, context: ConeTypeContext): ConeKotlinType {
    ...
    val combinedCustomAttribute = attributes.custom?.add(customAttributesFromOther) ?: customAttributesFromOther
    val combinedConeAttributes = attributes.add(ConeAttributes.create(listOf(combinedCustomAttribute)))
