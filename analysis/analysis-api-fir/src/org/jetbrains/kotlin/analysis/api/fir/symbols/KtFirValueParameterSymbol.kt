    ...
    override val name: Name by cached {
        firRef.withFir { fir ->
            ...
            fir.withFirDeclaration(resolveState, FirResolvePhase.TYPES) {
                ...
                // Resolve to BODY_RESOLVE phase to get `name` argument from mapping.
                val parameterNameFromAnnotation = parentFirDeclaration.withFirDeclaration(resolveState, FirResolvePhase.BODY_RESOLVE) {
                    val nameArgument =
