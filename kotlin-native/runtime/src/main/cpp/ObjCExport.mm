...
static kotlin::SpinLock<kotlin::ThreadStateHandling::kSwitchIfRegistered> typeInfoCreationMutex;
...
static kotlin::SpinLock<kotlin::ThreadStateHandling::kSwitchIfRegistered> classCreationMutex;
