...
using IntList = SingleLockList<int, SpinLock<ThreadStateHandling::kIgnore>>;
...
TEST(SingleLockListTest, PinnedType) {
    SingleLockList<PinnedType, SpinLock<ThreadStateHandling::kIgnore>> list;
    constexpr int kFirst = 1;
...
TEST(SingleLockListTest, Destructor) {
    ...
    {
        SingleLockList<WithDestructorHook, SpinLock<ThreadStateHandling::kIgnore>> list;
